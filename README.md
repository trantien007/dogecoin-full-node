...
wget "https://github.com/dogecoin/dogecoin/releases/download/v1.14.7/dogecoin-1.14.7-x86_64-linux-gnu.tar.gz" -O dogecoin.tar.gz
...
addnode=46.101.229.187
addnode=104.236.195.15
addnode=178.62.81.244
addnode=162.243.252.124
addnode=45.77.226.171
addnode=51.91.158.170
addnode=94.23.250.95
addnode=198.50.144.148
```
